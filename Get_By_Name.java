...
public class Get_By_Name {
	private static final String sqlquery="{CALL get_Product_Details_By_Name(?,?)}";
		...
		try {
			...
			if(connection!=null) {
				...
				if(scanner!=null) {
					...
					System.out.println("Enter product name::");
					productname2=scanner.next();
				}
				if(callablestatement!=null) {
					callablestatement.setString(1, productname1);
					callablestatement.setString(2, productname2);
				}
				if(callablestatement!=null) {
